...
//			return "redirect:/ajustes/cambiarPassw?errorPassword=min5&caracters";
//		} else {
...
//	-----------------------------------------------------
	...
	@GetMapping("/ajustes/cuenta/eliminar")
	public String eliminarCuenta(Model model, RedirectAttributes atribute, Principal principal) {
		...
		if (usuario != null) {
			...
			// atribute.addFlashAttribute("warning", "Usuario ''" + usuario.getUsername() +
			// "'' eliminado con éxito.");
			return "redirect:/usuarios?codigo=" + principal.getName();
		} else {
			return "redirect:/ajustes/";
		}
	}
